...
class HomeVC: UIViewController {
    ...
    @IBOutlet weak var metroMapBTN: UIButton!
    ...
    override func viewDidLoad() {
        ...
        newTripButton.layer.cornerRadius = 18
        newTripButton.layer.masksToBounds = true
        
        metroMapBTN.layer.cornerRadius = 18
        metroMapBTN.layer.masksToBounds = true
        
    }
    
    @IBAction func newTripButton(_ sender: Any) {
